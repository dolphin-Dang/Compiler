    ...
    */
    ...
    if(ch0!=NULL && (strcmp(ch0->name, "ID")==0)){
        ...
        if(ch0ch0!=NULL && (strcmp(ch0ch0->name, "ID")==0)){
            ...
            FieldList field = lookUp(ch0ch0->name);
            if(field!=NULL){
    ...
    */
    ...
    if(ch1==NULL){
        ...
        if(strcmp(ch0->strval, "while")==0){
            ...
            insertInterCode(LABEL_OP, label2, NULL, NULL, NULL);
        }else{
    ...
    */
    ...
    if(ch1==NULL){
        ...
        if(strcmp(ch0->name, "LP")==0){
            ...
            FieldList fields = structField->type->u.structure;
            int bias = 0;
            while(fields!=NULL){
            ...
            if(exp1!=NULL && exp2!=NULL){
                ...
                if(field!=NULL){
                    ...
                    if(t!=NULL){
                        ...
                        Operand constOp = createOperand(CONS_OP, offset*elemSize, NULL);
                        Operand tempOpAddr = createOperand(TEMP_OP, NULL, NULL);
                        Operand tempOp = createOperand(TEMP_OP, NULL, NULL);
                        // insertInterCode(GET_ADDR_IC, tempOpAddr, exp1, NULL);
                        insertInterCode(ADD_IC, exp1, constOp, tempOpAddr, NULL);
